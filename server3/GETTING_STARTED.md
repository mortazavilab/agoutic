#!/usr/bin/env bash
# AGOUTIC Server 3 - Complete Getting Started Guide

cat << 'EOF'
╔════════════════════════════════════════════════════════════════════════╗
║              AGOUTIC SERVER 3 - GETTING STARTED GUIDE                 ║
...
### Check Imports
    python -c "from server3.app import app; print('✅ Imports OK')"
...
### Development Mode (with auto-reload)
    ...
    Output should show:
    ✅ Server 3 initialized: Database ready
...
### Alternative Port
    export PORT=8002
    uvicorn server3.app:app --host 0.0.0.0 --port $PORT
...
### Run Specific Test Class
    ...
    pytest server3/test_server3.py::TestDatabase -v
    pytest server3/test_server3.py::TestIntegration -v
...
### Run Integration Tests
    ...
    Expected: Tests run with Server 3 running

### Quick Syntax Check
    python -m py_compile server3/*.py
    # No output = success
...
### Submit DNA Job Only
    python server3/demo_server3.py dna
    # Returns: run_uuid (copy this)

### Submit RNA Job
    python server3/demo_server3.py rna

### Submit cDNA Job
    python server3/demo_server3.py cdna

### Track Specific Job
    python server3/demo_server3.py track <run_uuid>

### View Job Logs
    python server3/demo_server3.py logs <run_uuid>

### List All Jobs
    python server3/demo_server3.py list
...
### View Logs Files
    ls -la $AGOUTIC_ROOT/server3_logs/
    tail -f $AGOUTIC_ROOT/server3_logs/*.log

### View Work Directories
    ls -la /media/backup_disk/agoutic_root/server3_work/
    # Each has: nextflow.config, work/, timeline.html, report.html

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

## 7️⃣  INTEGRATE WITH SERVER 1

### Python Client Example
    import requests
    import json
    
    # Submit job from Server 1 Agent
...
### Connect from Server 1 (Future)
    # In server1/app.py @app.post("/chat")
    ...
    server3_response = requests.post(
        "http://server3:8001/jobs/submit",
        json=job_req.dict()
    )
    
    run_uuid = server3_response.json()["run_uuid"]
...
Solution:
  ...
  ls -la $AGOUTIC_ROOT/server3_work/
...
Solution:
  ...
  ls -la $AGOUTIC_ROOT/server3_work/<run_uuid>/results/
  
  # Check Nextflow reports
  cat $AGOUTIC_ROOT/server3_work/<run_uuid>/report.html
...
Test suite:        pytest server3/test_server3.py -v
Integration test:  python server3/test_integration.py
Interactive demo:  python server3/demo_server3.py

Database:          $AGOUTIC_ROOT/database/agoutic_v23.sqlite
Work directory:    $AGOUTIC_ROOT/server3_work/
Log files:         $AGOUTIC_ROOT/server3_logs/

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

🎉 You're all set! Start Server 3 and begin submitting jobs.

For more details: see README.md and other documentation files in server3/
