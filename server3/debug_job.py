...
Usage:
    python server3/debug_job.py <run_uuid>
    python server3/debug_job.py --work-dir /path/to/work/dir
"""
...
def check_job(work_dir: Path):
    ...
    # Check log files
    print(f"\n📋 Log Files:")
    log_dir = work_dir.parent.parent / "server3_logs"
...
def main():
    parser = argparse.ArgumentParser(description="Debug a Server 3 job")
    ...
    if args.work_dir:
        ...
        work_dir = Path("/media/backup_disk/agoutic_root/server3_work") / args.run_uuid
    else:
