"""
FastAPI REST API for Analyzer (Analysis Server).
...
from analyzer.config import ANALYZER_HOST, ANALYZER_PORT
...
# Configure logging
setup_logging("analyzer-rest")
logger = get_logger(__name__)

# Create FastAPI app
app = FastAPI(
    title="AGOUTIC Analyzer",
...
if __name__ == "__main__":
    ...
    logger.info(f"Starting Analyzer REST API on {ANALYZER_HOST}:{ANALYZER_PORT}")
    uvicorn.run(
        app,
        host=ANALYZER_HOST,
        port=ANALYZER_PORT,
