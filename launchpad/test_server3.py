"""
Comprehensive test suite for Launchpad.
...
async def db_session():
    ...
    from launchpad.db import SessionLocal, init_db
    await init_db()
...
class TestDatabase:
    ...
    async def test_create_job(self, db_session, sample_job_request):
        """Test job creation."""
        from launchpad.db import create_job
    ...
    async def test_get_job(self, db_session, sample_job_request):
        """Test job retrieval."""
        from launchpad.db import create_job, get_job
    ...
    async def test_update_job_status(self, db_session, sample_job_request):
        ...
        from launchpad.db import create_job, update_job_status
    ...
    async def test_add_log_entry(self, db_session, sample_job_request):
        ...
        from launchpad.db import create_job, add_log_entry, get_job_logs
...
class TestSchemas:
    ...
    def test_job_status_response_schema(self):
        ...
        from launchpad.schemas import JobStatusResponse
    ...
    def test_job_details_response_schema(self):
        ...
        from launchpad.schemas import JobDetailsResponse
...
class TestAPIEndpoints:
    ...
    async def test_root_endpoint(self):
        ...
        assert response.status_code == 200
        data = response.json()
        assert "AGOUTIC Launchpad" in data["service"]
...
class TestIntegration:
    ...
    async def test_multi_mode_support(self):
        ...
        from launchpad.nextflow_executor import NextflowConfig
        from launchpad.config import DogmeMode
...
class TestEdgeCases:
    ...
    async def test_nonexistent_job_retrieval(self):
        ...
        from launchpad.db import SessionLocal, init_db, get_job
