...
TOOL_SCHEMAS = {
    ...
    "test_contrast": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "significance_metric": {"type": "string", "description": "Summary significance metric: 'fdr' or 'pvalue'. Default: 'fdr'."},
                "significance_threshold": {"type": "number", "description": "Summary cutoff for the selected significance metric. Default: 0.05."},
            },
            "required": ["contrast"],
        },
    },
    ...
    "get_top_genes": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "fdr_threshold": {"type": "number", "description": "Legacy FDR cutoff alias (default: 0.05)."},
                "significance_metric": {"type": "string", "description": "Significance metric: 'fdr' or 'pvalue'. Default: 'fdr'."},
                "significance_threshold": {"type": "number", "description": "Cutoff for the selected significance metric. Default: 0.05."},
            },
            "required": [],
        },
    },
    ...
    "generate_plot": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "use_fdr_y": {"type": "boolean", "description": "For volcano plots, use -log10(FDR) on the y-axis instead of -log10(p-value)."},
                "pvalue_cutoff": {"type": "number", "description": "P-value cutoff for volcano significance and threshold annotation (default: 0.05)."},
                "fdr_cutoff": {"type": "number", "description": "FDR cutoff for volcano significance and threshold annotation (default: 0.05)."},
                "logfc_cutoff": {"type": "number", "description": "Absolute log2 fold-change cutoff for volcano/MD threshold annotation (default: 1.0)."},
    ...
    "filter_de_genes": {
        "description": "Filter DE results to extract gene lists for enrichment analysis. Splits by direction (up/down/all) with configurable significance and logFC thresholds.",
        "parameters": {
            "type": "object",
            "properties": {
