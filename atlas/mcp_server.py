"""
Atlas extended ENCODE MCP server.
...
from atlas.tool_schemas import TOOL_SCHEMAS as _ENCODE_TOOL_SCHEMAS


# --- Schema endpoint (fetched by Cortex at startup) ---
async def _tools_schema_endpoint(request):
    """Return machine-readable tool schemas for all ENCODE MCP tools."""
    return JSONResponse(_ENCODE_TOOL_SCHEMAS)
